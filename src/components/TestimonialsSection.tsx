            ...
            <div className="py-12 bg-[#1a1a1a] text-white">
                  <div className="container mx-auto px-4">
                        <div className="text-center mb-12">
                              ...
                              <p className="text-lg md:text-xl mt-4">What people say about us.</p>
                        </div>
                        <Slider {...settings}>
                              {testimonials.map((testimonial) => (
                                    <div key={testimonial.id} className="outline-none">
                                          <blockquote className="text-center p-4 italic font-medium text-lg md:text-xl">
                                                "{testimonial.content}"
                                                <div className="mt-4 font-bold text-base md:text-lg">{testimonial.author}</div>
                                          </blockquote>
                                    </div>
                              ))}
                        </Slider>
